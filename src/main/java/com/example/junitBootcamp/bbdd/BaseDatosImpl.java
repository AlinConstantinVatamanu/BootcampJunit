...
public class BaseDatosImpl implements BaseDatosI {
	...
	public void iniciar() {
		...
		baseDatos.put(1, new Articulo("Camiseta", 19.88));
		baseDatos.put(2, new Articulo("Pantalón", 21.88));
		baseDatos.put(3, new Articulo("Jersey", 15.88));
		baseDatos.put(4, new Articulo("Chaqueta", 32.88));
		baseDatos.put(5, new Articulo("Falta", 22.88));
	}
